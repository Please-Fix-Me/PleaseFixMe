...
export const BUSINESS_COLLECTION_NAME = "business"
export const OFFERING_COLLECTION_NAME = "offering"
...
export const ALLOWED_DEFECT_UPDATE_FIELDS = ['id', 'offeringName', 'businessName', 'statusChanges', 'status']
